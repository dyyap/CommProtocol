...
#ifndef PROTOBUF_INCLUDED_ProtoPackets_2eproto
#define PROTOBUF_INCLUDED_ProtoPackets_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_ProtoPackets_2eproto 
...
inline ::ProtoPackets::AirVehicleGroundRelativeState* Packet::mutable_airvehiclegroundrelativestate() {
  if (!has_airvehiclegroundrelativestate()) {
    ...
    packet_.airvehiclegroundrelativestate_ = CreateMaybeMessage< ::ProtoPackets::AirVehicleGroundRelativeState >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::ArmCommand* Packet::mutable_armcommand() {
  if (!has_armcommand()) {
    clear_packet();
    set_has_armcommand();
    packet_.armcommand_ = CreateMaybeMessage< ::ProtoPackets::ArmCommand >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::ArmPosition* Packet::mutable_armposition() {
  if (!has_armposition()) {
    clear_packet();
    set_has_armposition();
    packet_.armposition_ = CreateMaybeMessage< ::ProtoPackets::ArmPosition >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::Battery* Packet::mutable_battery() {
  if (!has_battery()) {
    clear_packet();
    set_has_battery();
    packet_.battery_ = CreateMaybeMessage< ::ProtoPackets::Battery >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::TargetAcknowledgement* Packet::mutable_targetacknowledgement() {
  if (!has_targetacknowledgement()) {
    ...
    packet_.targetacknowledgement_ = CreateMaybeMessage< ::ProtoPackets::TargetAcknowledgement >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::TargetDesignationCommand* Packet::mutable_targetdesignationcommand() {
  if (!has_targetdesignationcommand()) {
    ...
    packet_.targetdesignationcommand_ = CreateMaybeMessage< ::ProtoPackets::TargetDesignationCommand >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::TargetStatus* Packet::mutable_targetstatus() {
  if (!has_targetstatus()) {
    ...
    packet_.targetstatus_ = CreateMaybeMessage< ::ProtoPackets::TargetStatus >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::VehicleAttitude* Packet::mutable_vehicleattitude() {
  if (!has_vehicleattitude()) {
    ...
    packet_.vehicleattitude_ = CreateMaybeMessage< ::ProtoPackets::VehicleAttitude >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::VehicleAuthorizationReply* Packet::mutable_vehicleauthorizationreply() {
  if (!has_vehicleauthorizationreply()) {
    ...
    packet_.vehicleauthorizationreply_ = CreateMaybeMessage< ::ProtoPackets::VehicleAuthorizationReply >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::VehicleAuthorizationRequest* Packet::mutable_vehicleauthorizationrequest() {
  if (!has_vehicleauthorizationrequest()) {
    ...
    packet_.vehicleauthorizationrequest_ = CreateMaybeMessage< ::ProtoPackets::VehicleAuthorizationRequest >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::VehicleBodySensedState* Packet::mutable_vehiclebodysensedstate() {
  if (!has_vehiclebodysensedstate()) {
    ...
    packet_.vehiclebodysensedstate_ = CreateMaybeMessage< ::ProtoPackets::VehicleBodySensedState >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::VehicleGlobalPosition* Packet::mutable_vehicleglobalposition() {
  if (!has_vehicleglobalposition()) {
    ...
    packet_.vehicleglobalposition_ = CreateMaybeMessage< ::ProtoPackets::VehicleGlobalPosition >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::VehicleIdentification* Packet::mutable_vehicleidentification() {
  if (!has_vehicleidentification()) {
    ...
    packet_.vehicleidentification_ = CreateMaybeMessage< ::ProtoPackets::VehicleIdentification >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::VehicleInertialState* Packet::mutable_vehicleinertialstate() {
  if (!has_vehicleinertialstate()) {
    ...
    packet_.vehicleinertialstate_ = CreateMaybeMessage< ::ProtoPackets::VehicleInertialState >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::VehicleModeCommand* Packet::mutable_vehiclemodecommand() {
  if (!has_vehiclemodecommand()) {
    ...
    packet_.vehiclemodecommand_ = CreateMaybeMessage< ::ProtoPackets::VehicleModeCommand >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::VehicleSystemStatus* Packet::mutable_vehiclesystemstatus() {
  if (!has_vehiclesystemstatus()) {
    ...
    packet_.vehiclesystemstatus_ = CreateMaybeMessage< ::ProtoPackets::VehicleSystemStatus >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::VehicleTelemetryCommand* Packet::mutable_vehicletelemetrycommand() {
  if (!has_vehicletelemetrycommand()) {
    ...
    packet_.vehicletelemetrycommand_ = CreateMaybeMessage< ::ProtoPackets::VehicleTelemetryCommand >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::VehicleTerminationCommand* Packet::mutable_vehicleterminationcommand() {
  if (!has_vehicleterminationcommand()) {
    ...
    packet_.vehicleterminationcommand_ = CreateMaybeMessage< ::ProtoPackets::VehicleTerminationCommand >(
        GetArenaNoVirtual());
  }
...
inline ::ProtoPackets::VehicleWaypointCommand* Packet::mutable_vehiclewaypointcommand() {
  if (!has_vehiclewaypointcommand()) {
    ...
    packet_.vehiclewaypointcommand_ = CreateMaybeMessage< ::ProtoPackets::VehicleWaypointCommand >(
        GetArenaNoVirtual());
  }
...
#endif  // PROTOBUF_INCLUDED_ProtoPackets_2eproto
